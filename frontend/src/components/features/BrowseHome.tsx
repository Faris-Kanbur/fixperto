    ...
    <div ref={browseScrollRef} onScroll={() => setHeroCollapsed(c => { const collapsed = browseScrollRef.current.scrollTop > 36; return c === collapsed ? c : collapsed; })} className="flex-1 overflow-y-auto">
      ...
      {ownerMode === "mechanics" && (
        <div className="max-w-6xl mx-auto w-full px-5 md:px-8 py-4">
          <p className="text-xs text-gray-400 mb-3">{filtered.length} tamirci bulundu</p>
      ...
      {ownerMode === "cars" && (
        <div className="max-w-6xl mx-auto w-full px-5 md:px-8 py-4">
          ...
          <p className="text-xs text-gray-400 mb-3">{filteredListings.length} ilan bulundu</p>
          <div className="md:flex md:gap-6">
      ...
      {ownerMode === "jobs" && (
        <div className="max-w-6xl mx-auto w-full px-5 md:px-8 py-4">
          <p className="text-xs text-gray-400 mb-3">{filteredJobs.length} iş ilanı bulundu</p>
