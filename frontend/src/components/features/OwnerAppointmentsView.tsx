    ...
    <div>
      ...
      {ownerApptView === "quotes" && (
        <div className="space-y-3">
          <button onClick={() => setShowQuoteModal(true)} className="w-full border-2 border-dashed border-primary-subtle rounded-xl py-2.5 flex items-center justify-center gap-1.5 text-primary text-xs font-medium hover:bg-primary-tint transition"><Plus size={14} /> {t("newQuoteRequestBtn")}</button>
