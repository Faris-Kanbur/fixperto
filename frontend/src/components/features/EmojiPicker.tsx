  ...
  return (
    <>
      <button
        ...
        className={`w-10 h-10 flex items-center justify-center rounded-full transition flex-shrink-0 ${open ? "bg-rose-100 text-rose-600" : "bg-gray-100 text-gray-500 hover:bg-gray-200"}`}
      >
        <Smile size={18} />
      </button>
