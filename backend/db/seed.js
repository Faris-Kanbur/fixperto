...
// her "lock" numarası aynı gerçek arabanın gerçek fotoğrafına sabitleniyor.
const wc = (lock) => `https://loremflickr.com/800/600/car?lock=${lock}`;

const MECHANICS = [
  { id: 1, name: "Usta Mehmet Oto Servis", distance: 1.2, price: 350, rating: 4.8, reviews: 124, verified: 1, avgResponseMinutes: 9, specialty: "Genel Bakım, Motor", img: "🔧", lang: "tr", px: 30, py: 40, bannerPreset: "blue", coverPhoto: wc(9), lat: 40.9927, lng: 29.0275, iban: "", bankName: "", accountHolder: "", phone: "0216 345 67 89",
    address: "Bağdat Cad. No:45, Kadıköy / İstanbul", hoursText: [],
    services: [{ key: "oil_change", name: "Yağ Değişimi", price: "350₺", fixed: true, brandPrices: {"BMW": "900", "Mercedes-Benz": "950", "Audi": "880", "Toyota": "520", "Renault": "450"} }, { key: "periodic_service", name: "Genel Bakım", price: "600₺", fixed: true }, { key: "engine_diag", name: "Motor Kontrolü", price: "450₺", fixed: false }, { key: "battery", name: "Akü Değişimi", price: "900₺", fixed: true }],
    ...
    reviewList: [
      { id: 6001, name: "Ahmet K.", avatar: "🧔", rating: 5, comment: "Çok hızlı ve dürüst hizmet, tekrar geleceğim.", photo: true, photoUrl: wc(201) },
      { id: 6002, name: "Elif S.", avatar: "👩", rating: 4, comment: "Fiyat performans olarak gayet iyi.", photo: false },
      { id: 6003, name: "Burak T.", avatar: "👨", rating: 5, comment: "Ustalar çok ilgiliydi, aracımı zamanında teslim ettiler.", photo: true, photoUrl: wc(202) },
  ...
  { id: 2, name: "Hızlı Tamir Merkezi", distance: 2.5, price: 280, rating: 4.5, reviews: 89, verified: 1, avgResponseMinutes: 14, specialty: "Lastik, Fren", img: "🚗", lang: "tr", px: 55, py: 25, bannerPreset: "orange", coverPhoto: wc(10), lat: 39.9179, lng: 32.8627, iban: "", bankName: "", accountHolder: "", phone: "0312 456 78 90",
    ...
    services: [{ key: "tire_change", name: "Lastik Değişimi", price: "1200₺", fixed: true }, { key: "brake_pads", name: "Fren Balata", price: "700₺", fixed: true, brandPrices: {"BMW": "1900", "Mercedes-Benz": "2100", "Audi": "1800", "Toyota": "900", "Fiat": "750"} }, { key: "wheel_alignment", name: "Rot Balans", price: "400₺", fixed: true }],
    staff: [{ name: "Serkan Bey", role: "Servis Şefi", emoji: "👨‍🔧" }, { name: "Onur K.", role: "Lastik Ustası", emoji: "🧑‍🔧" }],
    reviewList: [{ id: 6004, name: "Fatma Y.", avatar: "👩‍🦰", rating: 4, comment: "Lastik değişimi çok hızlı oldu.", photo: false }, { id: 6005, name: "Kerem A.", avatar: "🧑", rating: 5, comment: "Fren sesim tamamen geçti.", photo: true, photoUrl: wc(203) }], verificationDocs: [], brandsServiced: ["Renault", "Fiat", "Ford", "Opel", "Hyundai", "Peugeot"], paymentMethods: ["Nakit", "Kredi/Banka Kartı"] },
  { id: 3, name: "Güven Oto", distance: 0.8, price: 420, rating: 4.9, reviews: 210, verified: 1, avgResponseMinutes: 6, specialty: "Elektrik, Elektronik", img: "⚡", lang: "tr", px: 45, py: 60, bannerPreset: "green", coverPhoto: wc(11), lat: 38.4192, lng: 27.1287, iban: "", bankName: "", accountHolder: "", phone: "0232 567 89 01",
    ...
    services: [{ key: "error_memory", name: "Elektrik Arıza Tespiti", price: "500₺", fixed: false }, { key: "battery_test", name: "Akü/Şarj Kontrolü", price: "300₺", fixed: true }],
    staff: [{ name: "Hakan Usta", role: "Elektrik Mühendisi", emoji: "👨‍🔧" }],
    reviewList: [{ id: 6006, name: "Tolga E.", avatar: "👨‍🦱", rating: 5, comment: "Arızayı dakikalar içinde buldular.", photo: true, photoUrl: wc(204) }], verificationDocs: [], brandsServiced: ["Volkswagen", "BMW", "Mercedes-Benz", "Audi"], paymentMethods: ["Nakit", "Kredi/Banka Kartı", "Havale/EFT"] },
  { id: 4, name: "Anadolu Servis", distance: 3.1, price: 250, rating: 4.2, reviews: 56, verified: 1, avgResponseMinutes: 22, specialty: "Yağ Değişimi, Bakım", img: "🛠️", lang: "tr", px: 70, py: 70, bannerPreset: "blue", coverPhoto: wc(12), lat: 40.1826, lng: 29.0610, iban: "", bankName: "", accountHolder: "", phone: "0224 678 90 12",
    ...
    services: [{ key: "oil_change", name: "Yağ Değişimi", price: "250₺", fixed: true, brandPrices: {"BMW": "900", "Mercedes-Benz": "950", "Audi": "880", "Toyota": "520", "Renault": "450"} }, { key: "cabin_filter", name: "Filtre Değişimi", price: "200₺", fixed: true }],
    staff: [{ name: "İsmail Usta", role: "Servis Sorumlusu", emoji: "👨‍🔧" }],
    reviewList: [{ id: 6007, name: "Nihal K.", avatar: "👩", rating: 4, comment: "Ekonomik ve iş bilir bir servis.", photo: false }, { id: 6008, name: "Kullanıcı8823", avatar: "🙄", rating: 1, comment: "Bu servise hiç gitmedim ama düşük puan bırakıyorum.", photo: false, flagged: true }], verificationDocs: [], brandsServiced: ["Renault", "Fiat", "Dacia", "Tofaş", "Hyundai"], paymentMethods: ["Nakit"] },
  { id: 5, name: "Star Auto Care", distance: 1.9, price: 500, rating: 4.7, reviews: 178, verified: 1, avgResponseMinutes: 11, specialty: "Kaporta, Boya", img: "✨", lang: "en", px: 20, py: 65, bannerPreset: "orange", coverPhoto: wc(13), lat: 41.0390, lng: 28.8560, iban: "", bankName: "", accountHolder: "", phone: "0212 789 01 23",
    ...
    services: [{ key: "body_repair", name: "Kaporta Onarımı", price: "1500₺", fixed: false, brandPrices: {"BMW": "2400", "Mercedes-Benz": "2600", "Audi": "2300", "Toyota": "1400", "Renault": "1200"} }, { key: "paint", name: "Boya İşlemi", price: "2000₺", fixed: false }],
    staff: [{ name: "John Miller", role: "Body Shop Lead", emoji: "👨‍🔧" }],
    reviewList: [{ id: 6009, name: "David R.", avatar: "🧑", rating: 5, comment: "Excellent paint job, looks brand new!", photo: true, photoUrl: wc(205) }], verificationDocs: [], brandsServiced: ["BMW", "Mercedes-Benz", "Audi", "Volkswagen", "Mini"], paymentMethods: ["Kredi/Banka Kartı", "Havale/EFT"] },
  { id: 6, name: "Ekonomik Tamir", distance: 4.2, price: 200, rating: 3.9, reviews: 34, verified: 0, avgResponseMinutes: 40, specialty: "Genel Bakım", img: "🔩", lang: "tr", px: 80, py: 35, bannerPreset: "green", coverPhoto: wc(14), lat: 37.8746, lng: 32.4932, iban: "", bankName: "", accountHolder: "", phone: "0332 890 12 34",
    ...
    services: [{ key: "periodic_service", name: "Genel Bakım", price: "200₺", fixed: true }, { key: "oil_change", name: "Yağ Değişimi", price: "220₺", fixed: true, brandPrices: {"BMW": "900", "Mercedes-Benz": "950", "Audi": "880", "Toyota": "520", "Renault": "450"} }],
    staff: [{ name: "Ramazan Usta", role: "Servis Sorumlusu", emoji: "👨‍🔧" }],
    reviewList: [{ id: 6010, name: "Cem S.", avatar: "👨", rating: 4, comment: "Uygun fiyat, iş de fena değil.", photo: false }], verificationDocs: [], brandsServiced: ["Fiat", "Renault", "Tofaş", "Dacia"], paymentMethods: ["Nakit"] },
  { id: 7, name: "Akdeniz Oto Bakım", distance: 2.7, price: 380, rating: 4.6, reviews: 97, verified: 1, avgResponseMinutes: 13, specialty: "Genel Bakım, Lastik", img: "🌊", lang: "tr", px: 25, py: 80, bannerPreset: "blue", coverPhoto: wc(15), lat: 36.8969, lng: 30.7133, iban: "", bankName: "", accountHolder: "", phone: "0242 901 23 45",
    ...
    services: [{ key: "tire_change", name: "Lastik Değişimi", price: "1100₺", fixed: true }, { key: "periodic_service", name: "Genel Bakım", price: "380₺", fixed: true }, { key: "ac_service", name: "Klima Bakımı", price: "450₺", fixed: true, brandPrices: {"BMW": "1400", "Mercedes-Benz": "1500", "Renault": "700"} }],
    staff: [{ name: "Yusuf Usta", role: "Servis Sorumlusu", emoji: "👨‍🔧" }, { name: "Barış K.", role: "Lastik Ustası", emoji: "🧑‍🔧" }],
    reviewList: [{ id: 6011, name: "Selin A.", avatar: "👩‍🦱", rating: 5, comment: "Tatilde arıza yaptı, aynı gün hallettiler.", photo: true, photoUrl: wc(206) }, { id: 6012, name: "Murat D.", avatar: "🧔", rating: 4, comment: "Nazik ve hızlı ekip.", photo: false }], verificationDocs: [], brandsServiced: ["Volkswagen", "Renault", "Fiat", "Ford", "Toyota", "Opel"], paymentMethods: ["Nakit", "Kredi/Banka Kartı", "Havale/EFT"] },
  { id: 8, name: "Gaziantep Teknik Servis", distance: 5.4, price: 300, rating: 4.3, reviews: 61, verified: 0, avgResponseMinutes: 35, specialty: "Klima, Egzoz", img: "🌡️", lang: "tr", px: 65, py: 55, bannerPreset: "orange", coverPhoto: wc(16), lat: 37.0662, lng: 37.3833, iban: "", bankName: "", accountHolder: "", phone: "0342 012 34 56",
    ...
    services: [{ key: "ac_gas", name: "Klima Gazı Dolumu", price: "500₺", fixed: true }, { key: "exhaust", name: "Egzoz Onarımı", price: "600₺", fixed: true }],
    staff: [{ name: "Halil Usta", role: "Servis Şefi", emoji: "👨‍🔧" }],
    reviewList: [{ id: 6013, name: "Emre T.", avatar: "👨", rating: 4, comment: "Klima gayet iyi soğutuyor şimdi.", photo: false }], verificationDocs: [], brandsServiced: ["Renault", "Fiat", "Hyundai", "Toyota"], paymentMethods: ["Nakit", "Kredi/Banka Kartı"] },
  { id: 9, name: "Trabzon Karadeniz Oto", distance: 3.6, price: 330, rating: 4.4, reviews: 48, verified: 1, avgResponseMinutes: 18, specialty: "Kaporta, Elektrik", img: "⚙️", lang: "tr", px: 15, py: 15, bannerPreset: "green", coverPhoto: wc(17), lat: 41.0027, lng: 39.7168, iban: "", bankName: "", accountHolder: "", phone: "0462 123 45 67",
    ...
    services: [{ key: "body_repair", name: "Kaporta Onarımı", price: "1300₺", fixed: false, brandPrices: {"BMW": "2400", "Mercedes-Benz": "2600", "Audi": "2300", "Toyota": "1400", "Renault": "1200"} }, { key: "error_memory", name: "Elektrik Arıza Tespiti", price: "450₺", fixed: false }],
    staff: [{ name: "Orhan Usta", role: "Kaporta Ustası", emoji: "👨‍🔧" }],
    reviewList: [{ id: 6014, name: "Gökhan B.", avatar: "🧑", rating: 5, comment: "Çarpma izini fark edilmeyecek şekilde düzelttiler.", photo: true, photoUrl: wc(207) }], verificationDocs: [], brandsServiced: ["Renault", "Ford", "Opel", "Volkswagen"], paymentMethods: ["Nakit", "Havale/EFT"] },
  { id: 10, name: "Eskişehir Genç Oto", distance: 1.5, price: 260, rating: 4.1, reviews: 40, verified: 0, avgResponseMinutes: 28, specialty: "Motor, Şanzıman", img: "🧰", lang: "tr", px: 50, py: 20, bannerPreset: "blue", coverPhoto: wc(18), lat: 39.7767, lng: 30.5206, iban: "", bankName: "", accountHolder: "", phone: "0222 234 56 78",
    ...
    services: [{ key: "engine_repair", name: "Motor Revizyonu", price: "3500₺", fixed: false }, { key: "gearbox", name: "Şanzıman Bakımı", price: "1200₺", fixed: false, brandPrices: {"BMW": "9500", "Audi": "9000", "Toyota": "5200"} }],
    staff: [{ name: "Kaan Usta", role: "Motor Ustası", emoji: "🧑‍🔧" }],
    reviewList: [{ id: 6015, name: "Pınar E.", avatar: "👩", rating: 4, comment: "Şanzıman sorunu çözüldü, teşekkürler.", photo: false }],
    verificationDocs: [
...
const LISTINGS = [
  { id: 1, sellerName: "Usta Mehmet Oto Servis", sellerType: "mechanic", brand: "Toyota", model: "Corolla", year: 2017, km: 98000, price: "410.000₺", description: "Bakımlı, hasar kaydı yok, servis geçmişi elimizde.", photo: wc(1), status: "active", px: 35, py: 45, offers: [], messages: [], fuelType: "Benzin", transmission: "Otomatik", power: "132", firstReg: "03.2017", color: "Beyaz", vehicleId: null,
    bodyType: "Sedan", engineSize: "1.6", drivetrain: "Önden Çekiş", ownerCount: 2, paintedParts: 0, changedParts: 0, tradeIn: 0, doorCount: 4, features: ["Klima", "Elektrikli Cam", "Elektrikli Ayna", "ABS", "Bluetooth"], photos: [wc(19)],
    seatCount: 5, fuelConsumption: "6.5", co2Emission: 148, emissionClass: "Euro 6", batteryCapacity: null, rangeKm: null, city: "İstanbul", negotiable: 0, inspectionReportUrl: "https://example.com/ekspertiz/ilan-1-toyota-corolla.pdf", featured: 1 },
  { id: 2, sellerName: "Ali Yıldız", sellerType: "owner", brand: "Renault", model: "Clio", year: 2019, km: 62000, price: "365.000₺", description: "Tek elden, düzenli bakımlı, değişensiz.", photo: wc(2), status: "reserved", px: 60, py: 30, offers: [], messages: [], fuelType: "Dizel", transmission: "Manuel", power: "90", firstReg: "07.2019", color: "Gri", vehicleId: null,
    bodyType: "Hatchback/5 Kapı", engineSize: "1.5 dCi", drivetrain: "Önden Çekiş", ownerCount: 1, paintedParts: 0, changedParts: 0, tradeIn: 1, doorCount: 5, features: ["Klima", "Elektrikli Cam", "Hız Sabitleyici (Cruise Control)", "Bluetooth"], photos: [wc(20)],
    seatCount: 5, fuelConsumption: "4.2", co2Emission: 110, emissionClass: "Euro 6", batteryCapacity: null, rangeKm: null, city: "İstanbul", negotiable: 1, inspectionReportUrl: null, featured: 0 },
  { id: 3, sellerName: "Zeynep Kaya", sellerType: "owner", brand: "BMW", model: "3.20i", year: 2020, km: 45000, price: "720.000₺", description: "Full bakımlı, boyasız, ilk sahibinden.", photo: wc(3), status: "active", px: 48, py: 60, offers: [], messages: [], fuelType: "Benzin", transmission: "Otomatik", power: "184", firstReg: "05.2020", color: "Siyah", vehicleId: null,
    ...
    seatCount: 5, fuelConsumption: "6.8", co2Emission: 155, emissionClass: "Euro 6", batteryCapacity: null, rangeKm: null, city: "İzmir", negotiable: 0, inspectionReportUrl: null, featured: 1 },
  { id: 4, sellerName: "Hızlı Tamir Merkezi", sellerType: "mechanic", brand: "Volkswagen", model: "Golf", year: 2018, km: 110000, price: "320.000₺", description: "Dizel, ekonomik, düzenli servis kayıtlı.", photo: wc(4), status: "active", px: 20, py: 25, offers: [], messages: [], fuelType: "Dizel", transmission: "Manuel", power: "115", firstReg: "02.2018", color: "Mavi", vehicleId: null,
    ...
    seatCount: 5, fuelConsumption: "4.5", co2Emission: 118, emissionClass: "Euro 6", batteryCapacity: null, rangeKm: null, city: "Ankara", negotiable: 1, inspectionReportUrl: "https://example.com/ekspertiz/ilan-4-vw-golf.pdf", featured: 0 },
  { id: 5, sellerName: "Mehmet Demir", sellerType: "owner", brand: "Fiat", model: "Egea", year: 2021, km: 30000, price: "480.000₺", description: "Az kullanılmış, garaj arabası, hasarsız.", photo: wc(5), status: "sold", px: 72, py: 42, offers: [], messages: [], fuelType: "Benzin", transmission: "Manuel", power: "95", firstReg: "01.2021", color: "Kırmızı", vehicleId: null,
  ...
  { id: 6, sellerName: "Güven Oto", sellerType: "mechanic", brand: "Mercedes-Benz", model: "C 200", year: 2016, km: 150000, price: "650.000₺", description: "Otomatik vites, deri döşeme, bakımları düzenli yapılmış.", photo: wc(6), status: "active", px: 55, py: 15, offers: [], messages: [], fuelType: "Dizel", transmission: "Otomatik", power: "170", firstReg: "09.2016", color: "Gümüş", vehicleId: null,
    ...
    seatCount: 5, fuelConsumption: "5.1", co2Emission: 134, emissionClass: "Euro 6", batteryCapacity: null, rangeKm: null, city: "İzmir" },
  { id: 7, sellerName: "Elif S.", sellerType: "owner", brand: "Hyundai", model: "i20", year: 2022, km: 15000, price: "550.000₺", description: "Sıfıra yakın, garantisi devam ediyor.", photo: wc(7), status: "reserved", px: 30, py: 70, offers: [], messages: [], fuelType: "Benzin", transmission: "Manuel", power: "100", firstReg: "06.2022", color: "Beyaz", vehicleId: null,
    ...
    seatCount: 5, fuelConsumption: "5.6", co2Emission: 128, emissionClass: "Euro 6", batteryCapacity: null, rangeKm: null, city: "Antalya" },
  { id: 8, sellerName: "Anadolu Servis", sellerType: "mechanic", brand: "Audi", model: "A3", year: 2019, km: 80000, price: "610.000₺", description: "Sportback, dizel, bakımlı ve temiz.", photo: wc(8), status: "active", px: 82, py: 65, offers: [], messages: [], fuelType: "Dizel", transmission: "Otomatik", power: "150", firstReg: "04.2019", color: "Gri", vehicleId: null,
    ...
    seatCount: 5, fuelConsumption: "4.3", co2Emission: 113, emissionClass: "Euro 6", batteryCapacity: null, rangeKm: null, city: "Bursa" },
];
...
export function seedIfEmpty() {
  if (isEmpty("mechanics")) {
    const stmt = db.prepare(`INSERT INTO mechanics (id,name,distance,price,rating,reviews,verified,avgResponseMinutes,specialty,img,lang,px,py,bannerPreset,coverPhoto,lat,lng,iban,bankName,accountHolder,address,hoursText,services,staff,reviewList,verificationDocs,brandsServiced,paymentMethods,phone)
    VALUES (@id,@name,@distance,@price,@rating,@reviews,@verified,@avgResponseMinutes,@specialty,@img,@lang,@px,@py,@bannerPreset,@coverPhoto,@lat,@lng,@iban,@bankName,@accountHolder,@address,@hoursText,@services,@staff,@reviewList,@verificationDocs,@brandsServiced,@paymentMethods,@phone)`);
  ...
  if (isEmpty("listings")) {
    const stmt = db.prepare(`INSERT INTO listings (id,sellerName,sellerType,brand,model,year,km,price,description,photo,status,px,py,offers,messages,fuelType,transmission,power,firstReg,color,vehicleId,bodyType,engineSize,drivetrain,ownerCount,paintedParts,changedParts,tradeIn,doorCount,features,photos,seatCount,fuelConsumption,co2Emission,emissionClass,batteryCapacity,rangeKm,city,negotiable,inspectionReportUrl,featured)
    VALUES (@id,@sellerName,@sellerType,@brand,@model,@year,@km,@price,@description,@photo,@status,@px,@py,@offers,@messages,@fuelType,@transmission,@power,@firstReg,@color,@vehicleId,@bodyType,@engineSize,@drivetrain,@ownerCount,@paintedParts,@changedParts,@tradeIn,@doorCount,@features,@photos,@seatCount,@fuelConsumption,@co2Emission,@emissionClass,@batteryCapacity,@rangeKm,@city,@negotiable,@inspectionReportUrl,@featured)`);
    const insertMany = db.transaction((rows) => { for (const l of rows) stmt.run({ ...l, offers: j(l.offers), messages: j(l.messages), bodyType: l.bodyType || null, engineSize: l.engineSize || null, drivetrain: l.drivetrain || null, ownerCount: l.ownerCount ?? null, paintedParts: l.paintedParts ?? 0, changedParts: l.changedParts ?? 0, tradeIn: l.tradeIn ? 1 : 0, doorCount: l.doorCount ?? null, features: j(l.features || []), photos: j(l.photos || []), seatCount: l.seatCount ?? null, fuelConsumption: l.fuelConsumption || null, co2Emission: l.co2Emission ?? null, emissionClass: l.emissionClass || null, batteryCapacity: l.batteryCapacity || null, rangeKm: l.rangeKm ?? null, city: l.city || null, negotiable: l.negotiable ? 1 : 0, inspectionReportUrl: l.inspectionReportUrl || null, featured: l.featured ? 1 : 0 }); });
    insertMany(LISTINGS);
  }
  ...
  // BLOG — SEO'nun asıl motoru. İçerik ayrı dosyada (blogSeed.js) tutuluyor: uzun metinler
  // seed mantığını okunmaz hale getiriyordu. Her yazı gerçek bir Google aramasını hedefliyor
  // ve `relatedServiceKey` ile bir hizmete bağlı — yazının sonundaki bağlantı o hizmeti veren
  // tamircilerin FİLTRELENMİŞ listesini açıyor.
  if (isEmpty("blog_posts")) {
    const stmt = db.prepare(`INSERT INTO blog_posts (slug,title,excerpt,body,coverPhoto,tags,author,lang,status,publishedAt,views,relatedServiceKey,createdAt)
    VALUES (@slug,@title,@excerpt,@body,@coverPhoto,@tags,@author,@lang,@status,@publishedAt,@views,@relatedServiceKey,@createdAt)`);
    const now = Date.now();
    const insertMany = db.transaction((rows) => {
      rows.forEach((post, i) => {
        // Yayın tarihleri birer gün arayla geriye doğru: listede hepsi aynı anda yayınlanmış
        // gibi görünmesin, sıralama anlamlı olsun.
        const publishedAt = new Date(now - i * 86400000).toISOString();
        stmt.run({
          slug: post.slug, title: post.title, excerpt: post.excerpt, body: post.body,
          coverPhoto: post.coverPhoto || null, tags: j(post.tags || []),
          author: "Fixperto", lang: "tr", status: "published",
          publishedAt, views: 0, relatedServiceKey: post.relatedServiceKey || null,
          createdAt: publishedAt,
        });
      });
    });
    insertMany(BLOG_SEED_POSTS);
  }
