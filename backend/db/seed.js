...
const MECHANICS = [
  { id: 1, name: "Usta Mehmet Oto Servis", distance: 1.2, price: 350, rating: 4.8, reviews: 124, verified: 1, avgResponseMinutes: 9, specialty: "Genel Bakım, Motor", img: "🔧", lang: "tr", px: 30, py: 40, bannerPreset: "blue", coverPhoto: wc(9), lat: 40.9927, lng: 29.0275, iban: "", bankName: "", accountHolder: "",
  ...
  { id: 2, name: "Hızlı Tamir Merkezi", distance: 2.5, price: 280, rating: 4.5, reviews: 89, verified: 1, avgResponseMinutes: 14, specialty: "Lastik, Fren", img: "🚗", lang: "tr", px: 55, py: 25, bannerPreset: "orange", coverPhoto: wc(10), lat: 39.9179, lng: 32.8627, iban: "", bankName: "", accountHolder: "",
  ...
  { id: 3, name: "Güven Oto", distance: 0.8, price: 420, rating: 4.9, reviews: 210, verified: 1, avgResponseMinutes: 6, specialty: "Elektrik, Elektronik", img: "⚡", lang: "tr", px: 45, py: 60, bannerPreset: "green", coverPhoto: wc(11), lat: 38.4192, lng: 27.1287, iban: "", bankName: "", accountHolder: "",
  ...
  { id: 4, name: "Anadolu Servis", distance: 3.1, price: 250, rating: 4.2, reviews: 56, verified: 1, avgResponseMinutes: 22, specialty: "Yağ Değişimi, Bakım", img: "🛠️", lang: "tr", px: 70, py: 70, bannerPreset: "blue", coverPhoto: wc(12), lat: 40.1826, lng: 29.0610, iban: "", bankName: "", accountHolder: "",
  ...
  { id: 5, name: "Star Auto Care", distance: 1.9, price: 500, rating: 4.7, reviews: 178, verified: 1, avgResponseMinutes: 11, specialty: "Kaporta, Boya", img: "✨", lang: "en", px: 20, py: 65, bannerPreset: "orange", coverPhoto: wc(13), lat: 41.0390, lng: 28.8560, iban: "", bankName: "", accountHolder: "",
  ...
  { id: 6, name: "Ekonomik Tamir", distance: 4.2, price: 200, rating: 3.9, reviews: 34, verified: 0, avgResponseMinutes: 40, specialty: "Genel Bakım", img: "🔩", lang: "tr", px: 80, py: 35, bannerPreset: "green", coverPhoto: wc(14), lat: 37.8746, lng: 32.4932, iban: "", bankName: "", accountHolder: "",
  ...
  { id: 7, name: "Akdeniz Oto Bakım", distance: 2.7, price: 380, rating: 4.6, reviews: 97, verified: 1, avgResponseMinutes: 13, specialty: "Genel Bakım, Lastik", img: "🌊", lang: "tr", px: 25, py: 80, bannerPreset: "blue", coverPhoto: wc(15), lat: 36.8969, lng: 30.7133, iban: "", bankName: "", accountHolder: "",
  ...
  { id: 8, name: "Gaziantep Teknik Servis", distance: 5.4, price: 300, rating: 4.3, reviews: 61, verified: 0, avgResponseMinutes: 35, specialty: "Klima, Egzoz", img: "🌡️", lang: "tr", px: 65, py: 55, bannerPreset: "orange", coverPhoto: wc(16), lat: 37.0662, lng: 37.3833, iban: "", bankName: "", accountHolder: "",
  ...
  { id: 9, name: "Trabzon Karadeniz Oto", distance: 3.6, price: 330, rating: 4.4, reviews: 48, verified: 1, avgResponseMinutes: 18, specialty: "Kaporta, Elektrik", img: "⚙️", lang: "tr", px: 15, py: 15, bannerPreset: "green", coverPhoto: wc(17), lat: 41.0027, lng: 39.7168, iban: "", bankName: "", accountHolder: "",
  ...
  { id: 10, name: "Eskişehir Genç Oto", distance: 1.5, price: 260, rating: 4.1, reviews: 40, verified: 0, avgResponseMinutes: 28, specialty: "Motor, Şanzıman", img: "🧰", lang: "tr", px: 50, py: 20, bannerPreset: "blue", coverPhoto: wc(18), lat: 39.7767, lng: 30.5206, iban: "", bankName: "", accountHolder: "",
...
const LISTINGS = [
  { id: 1, sellerName: "Usta Mehmet Oto Servis", sellerType: "mechanic", brand: "Toyota", model: "Corolla", year: 2017, km: 98000, price: "410.000₺", description: "Bakımlı, hasar kaydı yok, servis geçmişi elimizde.", photo: wc(1), status: "active", px: 35, py: 45, offers: [], messages: [], fuelType: "Benzin", transmission: "Otomatik", power: "132", firstReg: "03.2017", color: "Beyaz", vehicleId: null,
    ...
    seatCount: 5, fuelConsumption: "6.5", co2Emission: 148, emissionClass: "Euro 6", batteryCapacity: null, rangeKm: null, city: "İstanbul" },
  { id: 2, sellerName: "Ali Yıldız", sellerType: "owner", brand: "Renault", model: "Clio", year: 2019, km: 62000, price: "365.000₺", description: "Tek elden, düzenli bakımlı, değişensiz.", photo: wc(2), status: "reserved", px: 60, py: 30, offers: [], messages: [], fuelType: "Dizel", transmission: "Manuel", power: "90", firstReg: "07.2019", color: "Gri", vehicleId: null,
    ...
    seatCount: 5, fuelConsumption: "4.2", co2Emission: 110, emissionClass: "Euro 6", batteryCapacity: null, rangeKm: null, city: "İstanbul" },
  { id: 3, sellerName: "Zeynep Kaya", sellerType: "owner", brand: "BMW", model: "3.20i", year: 2020, km: 45000, price: "720.000₺", description: "Full bakımlı, boyasız, ilk sahibinden.", photo: wc(3), status: "active", px: 48, py: 60, offers: [], messages: [], fuelType: "Benzin", transmission: "Otomatik", power: "184", firstReg: "05.2020", color: "Siyah", vehicleId: null,
    ...
    seatCount: 5, fuelConsumption: "6.8", co2Emission: 155, emissionClass: "Euro 6", batteryCapacity: null, rangeKm: null, city: "İzmir" },
  { id: 4, sellerName: "Hızlı Tamir Merkezi", sellerType: "mechanic", brand: "Volkswagen", model: "Golf", year: 2018, km: 110000, price: "320.000₺", description: "Dizel, ekonomik, düzenli servis kayıtlı.", photo: wc(4), status: "active", px: 20, py: 25, offers: [], messages: [], fuelType: "Dizel", transmission: "Manuel", power: "115", firstReg: "02.2018", color: "Mavi", vehicleId: null,
    ...
    seatCount: 5, fuelConsumption: "4.5", co2Emission: 118, emissionClass: "Euro 6", batteryCapacity: null, rangeKm: null, city: "Ankara" },
