...
const MECHANICS = [
  { id: 1, name: "Usta Mehmet Oto Servis", distance: 1.2, price: 350, rating: 4.8, reviews: 124, verified: 1, avgResponseMinutes: 9, specialty: "Genel Bakım, Motor", img: "🔧", lang: "tr", px: 30, py: 40, bannerPreset: "blue", coverPhoto: wc(9), lat: 40.9927, lng: 29.0275, iban: "", bankName: "", accountHolder: "",
    ...
    reviewList: [
      { name: "Ahmet K.", avatar: "🧔", rating: 5, comment: "Çok hızlı ve dürüst hizmet, tekrar geleceğim.", photo: true, photoUrl: wc(201) },
      { name: "Elif S.", avatar: "👩", rating: 4, comment: "Fiyat performans olarak gayet iyi.", photo: false },
      { name: "Burak T.", avatar: "👨", rating: 5, comment: "Ustalar çok ilgiliydi, aracımı zamanında teslim ettiler.", photo: true, photoUrl: wc(202) },
  ...
  { id: 2, name: "Hızlı Tamir Merkezi", distance: 2.5, price: 280, rating: 4.5, reviews: 89, verified: 1, avgResponseMinutes: 14, specialty: "Lastik, Fren", img: "🚗", lang: "tr", px: 55, py: 25, bannerPreset: "orange", coverPhoto: wc(10), lat: 39.9179, lng: 32.8627, iban: "", bankName: "", accountHolder: "",
    ...
    reviewList: [{ name: "Fatma Y.", avatar: "👩‍🦰", rating: 4, comment: "Lastik değişimi çok hızlı oldu.", photo: false }, { name: "Kerem A.", avatar: "🧑", rating: 5, comment: "Fren sesim tamamen geçti.", photo: true, photoUrl: wc(203) }], verificationDocs: [], brandsServiced: ["Renault", "Fiat", "Ford", "Opel", "Hyundai", "Peugeot"], paymentMethods: ["Nakit", "Kredi/Banka Kartı"] },
  { id: 3, name: "Güven Oto", distance: 0.8, price: 420, rating: 4.9, reviews: 210, verified: 1, avgResponseMinutes: 6, specialty: "Elektrik, Elektronik", img: "⚡", lang: "tr", px: 45, py: 60, bannerPreset: "green", coverPhoto: wc(11), lat: 38.4192, lng: 27.1287, iban: "", bankName: "", accountHolder: "",
    ...
    reviewList: [{ name: "Tolga E.", avatar: "👨‍🦱", rating: 5, comment: "Arızayı dakikalar içinde buldular.", photo: true, photoUrl: wc(204) }], verificationDocs: [], brandsServiced: ["Volkswagen", "BMW", "Mercedes-Benz", "Audi"], paymentMethods: ["Nakit", "Kredi/Banka Kartı", "Havale/EFT"] },
  ...
  { id: 5, name: "Star Auto Care", distance: 1.9, price: 500, rating: 4.7, reviews: 178, verified: 1, avgResponseMinutes: 11, specialty: "Kaporta, Boya", img: "✨", lang: "en", px: 20, py: 65, bannerPreset: "orange", coverPhoto: wc(13), lat: 41.0390, lng: 28.8560, iban: "", bankName: "", accountHolder: "",
    ...
    reviewList: [{ name: "David R.", avatar: "🧑", rating: 5, comment: "Excellent paint job, looks brand new!", photo: true, photoUrl: wc(205) }], verificationDocs: [], brandsServiced: ["BMW", "Mercedes-Benz", "Audi", "Volkswagen", "Mini"], paymentMethods: ["Kredi/Banka Kartı", "Havale/EFT"] },
  ...
  { id: 7, name: "Akdeniz Oto Bakım", distance: 2.7, price: 380, rating: 4.6, reviews: 97, verified: 1, avgResponseMinutes: 13, specialty: "Genel Bakım, Lastik", img: "🌊", lang: "tr", px: 25, py: 80, bannerPreset: "blue", coverPhoto: wc(15), lat: 36.8969, lng: 30.7133, iban: "", bankName: "", accountHolder: "",
    ...
    reviewList: [{ name: "Selin A.", avatar: "👩‍🦱", rating: 5, comment: "Tatilde arıza yaptı, aynı gün hallettiler.", photo: true, photoUrl: wc(206) }, { name: "Murat D.", avatar: "🧔", rating: 4, comment: "Nazik ve hızlı ekip.", photo: false }], verificationDocs: [], brandsServiced: ["Volkswagen", "Renault", "Fiat", "Ford", "Toyota", "Opel"], paymentMethods: ["Nakit", "Kredi/Banka Kartı", "Havale/EFT"] },
  ...
  { id: 9, name: "Trabzon Karadeniz Oto", distance: 3.6, price: 330, rating: 4.4, reviews: 48, verified: 1, avgResponseMinutes: 18, specialty: "Kaporta, Elektrik", img: "⚙️", lang: "tr", px: 15, py: 15, bannerPreset: "green", coverPhoto: wc(17), lat: 41.0027, lng: 39.7168, iban: "", bankName: "", accountHolder: "",
    ...
    reviewList: [{ name: "Gökhan B.", avatar: "🧑", rating: 5, comment: "Çarpma izini fark edilmeyecek şekilde düzelttiler.", photo: true, photoUrl: wc(207) }], verificationDocs: [], brandsServiced: ["Renault", "Ford", "Opel", "Volkswagen"], paymentMethods: ["Nakit", "Havale/EFT"] },
